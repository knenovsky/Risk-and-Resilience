# remove all values that scale with country size and local currency unit (lcu)
...
c(
  ...
  ## "DC.ODA.TOTL.KD",            ## Net ODA provided, total (constant 2015 US$)
  ...
  ## "DT.ODA.ALLD.KD",            ## Net official development assistance and official aid received (constant 2018 US$)
  ## "DT.ODA.OATL.CD",            ## Net official aid received (current US$)
  ## "DT.ODA.OATL.KD",            ## Net official aid received (constant 2018 US$)
  ...
  ## "EN.ATM.CO2E.KT",            ## Total CO2 emissions (thousand metric tons of CO2 excluding Land-Use Change and Forestry)
  ...
  ## "EN.ATM.GHGT.KT.CE",         ## Total greenhouse gas emissions (thousand metric tons of CO2 equivalent excluding Land-Use Change and Forestry)
  ...
  ## "EN.ATM.METH.KT.CE",         ## Total methane emissions (thousand metric tons of CO2 equivalent excluding Land-Use Change and Forestry)
  ...
  "IC.FRM.CRIM.ZS",            ## Losses due to theft and vandalism (% of annual sales of affected firms)
  ...
  ## "NE.CON.PRVT.CD",            ## Household and NPISHs Final consumption expenditure (current US$)
  ## "NE.CON.PRVT.CN",            ## Household and NPISHs Final consumption expenditure (current LCU)
  ...
  ## "NE.CON.PRVT.KN",            ## Household and NPISHs Final consumption expenditure (constant LCU)
  ...
  ## "NE.CON.PRVT.PP.KD",         ## Households and NPISHs Final consumption expenditure, PPP (constant 2017 international $)
  ...
  "SI.POV.MDIM.17",            ## Multidimensional poverty headcount ratio, children (% of child population)
  "SI.POV.MDIM.17.XQ",         ## Multidimensional poverty index, children (scale 0-1)
  ...
  "SI.POV.MDIM.IT",            ## Multidimensional poverty intensity
  ...
  "EN.ATM.CO2E.PC",       ##CO2 emissions (metric tons per capita)
  ##"MS.MIL.XPND.CD",     ##Military expenditures data from SIPRI.
