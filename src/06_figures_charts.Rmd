...
# ?ggcoef_compare
f<-lm(pscore_mean~iso1+iso2+iso3+iso4+iso5+iso6+iso7+iso8+iso9+iso10,dimred2021_knn250_2[])
...
```{r}
dimred2021_knn250_2 %>%  filter(year%in% 2019)->dimred2021_knn250_3
yo<-dimred2021_knn250_3[,c(10:680)]
# Combine target feature and isomap features into one data frame
df <- data.frame(target = dimred2021_knn250_3$pscore_mean, yo)
