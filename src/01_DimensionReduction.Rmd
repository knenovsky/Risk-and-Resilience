...
EXMORT_DIR    <- "../data/230225_WHO_Excess_Mort/2022-03-25_covid-19_gem" # Data available in the appendix of https://www.nature.com/articles/s41586-022-05522-2
...
wdi_series_path   <- file.path(WDI_DIR, "WDISeries.csv") #contains more information on the single indicators.
wdi_data_path     <- file.path(WDI_DIR, "WDIData.csv") #contains the main data table.
wdi_country_path  <- file.path(WDI_DIR, "WDICountry.csv") #contains more information on the countries and regions.
...
Include only countries with available Excess Mortality
