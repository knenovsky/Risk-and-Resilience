...
```{r}
# thesenames<-fread("../../23_01_COCAP/01_low_dim_paper/data2018/indicator_compressed_names.csv")
# wdi_explained[wdi_explained$`Series Code`%in% colnames(wdi_data_cons),] %>% 
#    select(`Series Code`,`Indicator Name`) %>% merge( .  ,thesenames,,by.x="Series Code",by.y="Indicator Code",all.x=T) %>% fwrite("../output/02_all_features_wdi.csv",sep=";")
