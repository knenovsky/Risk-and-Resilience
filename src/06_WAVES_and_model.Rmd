...
out_month2$value<-NULL

out_month2$month <- as.yearmon(out_month2$monthyear, format = "%Y_%m")
...
```{r}
features<-c("iso1","iso2","iso3","iso4","iso5","iso6","iso7","PC1","PC2","PC3","PC4","PC5","PC6","PC7","PC8","PC9","PC10","PC11","PC12","PC13","PC14")
