...
trials <- 1000
cl <- makeCluster(10)
>>>>>>> 59b837254c47d665afcbf4f4ed9e1f4b315fa540
...
used_var_names_max_dcor <- c(
  dcor_var_iso_cons[, 1] %>% order(decreasing = TRUE) %>% { .[1:05] } %>% { names(dcor_var_iso_cons[., 1]) },
  dcor_var_iso_cons[, 2] %>% order(decreasing = TRUE) %>% { .[1:05] } %>% { names(dcor_var_iso_cons[., 2]) },
  dcor_var_iso_cons[, 3] %>% order(decreasing = TRUE) %>% { .[1:20] } %>% { names(dcor_var_iso_cons[., 3]) },
  dcor_var_iso_cons[, 4] %>% order(decreasing = TRUE) %>% { .[1:20] } %>% { names(dcor_var_iso_cons[., 4]) },
  dcor_var_iso_cons[, 5] %>% order(decreasing = TRUE) %>% { .[1:05] } %>% { names(dcor_var_iso_cons[., 5]) },
  dcor_var_iso_cons[, 6] %>% order(decreasing = TRUE) %>% { .[1:05] } %>% { names(dcor_var_iso_cons[., 6]) },
...
dimred2021_knn250_3$p_score_level_label %>%  table
dimred2021_knn250_3 %>% select(pscore_mean,p_score_level_label,pscore_level)
dimred2021_knn250_3 %>% filter(year%in% 2015:2021) %>% group_by(year,p_score_level_label) %>% summarise(valueA=mean(SL.TLF.ACTI.1524.MA.NE.ZS,na.rm=T)) %>% ggplot(aes(y=valueA,x=year,color=p_score_level_label))+ geom_point()+ geom_line()+ ggtitle(wdi_explained[wdi_explained$`Series Code`%in% "SL.TLF.ACTI.1524.MA.NE.ZS","Indicator Name"])+ scale_color_viridis(discrete = T)+ theme_blank()
```
...
```{r}
dimred2021_knn250_3 %>% filter(year%in% 2015:2021) %>% group_by(year,p_score_level_label) %>% summarise(valueA=mean(SL.EMP.TOTL.SP.FE.NE.ZS,na.rm=T)) %>% ggplot(aes(y=valueA,x=year,color=p_score_level_label))+ geom_point()+ geom_line()+ ggtitle(wdi_explained[wdi_explained$`Series Code`%in% "SL.EMP.TOTL.SP.FE.NE.ZS","Indicator Name"])+ scale_color_viridis(discrete = T)+ theme_blank()

Indicator<-"EN.ATM.CO2E.KD.GD"
year_start<-"2015"
year_end<-"2021"

(get_wdi_trajectory(data=dimred2021_knn250_3,"EN.ATM.CO2E.KD.GD"))


dimred2021_knn250_3 %>% filter(year%in% 2015:2021) %>% group_by(year,p_score_level_label,) %>% summarise(valueA=length(unique(`Country Code`)))
```


```{r}
dimred2021_knn250_3 %>% filter(year%in% 2015:2021) %>% group_by(year,pscore_cat2) %>% summarise(valueA=mean(SP.POP.7074.MA.5Y,na.rm=T)) %>% ggplot(aes(y=valueA,x=year,color=pscore_cat2))+ geom_point()+ geom_line()+ ggtitle(wdi_explained[wdi_explained$`Series Code`%in% "SP.POP.7074.MA.5Y","Indicator Name"])+ scale_color_viridis(discrete = T)+ theme_blank()


dimred2021_knn250_3 %>% filter(year%in% 2015:2021) %>% group_by(year,pscore_level) %>% summarise(valueA=mean(VC.IHR.PSRC.P5,na.rm=T)) %>% ggplot(aes(y=valueA,x=year,color=pscore_level))+ geom_point()+ geom_line()+ ggtitle(wdi_explained[wdi_explained$`Series Code`%in% "VC.IHR.PSRC.P5","Indicator Name"])+ scale_color_viridis(discrete = T)+ theme_blank()
```


```{r}
dimred2021_knn250_3 %>% filter(year%in% 2015:2021) %>% group_by(year,pscore_level) %>% summarise(valueA=mean(TM.VAL.MRCH.R3.ZS,na.rm=T)) %>% ggplot(aes(y=valueA,x=year,color=pscore_level))+ geom_point()+ geom_line()+ ggtitle(wdi_explained[wdi_explained$`Series Code`%in% "TM.VAL.MRCH.R3.ZS","Indicator Name"])+ scale_color_viridis(discrete = T)+ theme_blank()
dimred2021_knn250_3 %>% filter(year%in% 2015:2021) %>% group_by(year,pscore_level) %>% summarise(valueA=mean(TX.VAL.MRCH.R3.ZS,na.rm=T)) %>% ggplot(aes(y=valueA,x=year,color=pscore_level))+ geom_point()+ geom_line()+ ggtitle(wdi_explained[wdi_explained$`Series Code`%in% "TX.VAL.MRCH.R3.ZS","Indicator Name"])+ scale_color_viridis(discrete = T)+ theme_blank()
```
```{r}
...
```{r}
dimred2021_knn250_3 %>% filter(year%in% 2015:2021) %>% group_by(year,pscore_level) %>% summarise(valueA=mean(SL.TLF.INTM.ZS,na.rm=T)) %>% ggplot(aes(y=valueA,x=year,color=pscore_cat2))+ geom_point()+ geom_line()+ ggtitle(wdi_explained[wdi_explained$`Series Code`%in% "SL.TLF.INTM.ZS","Indicator Name"])+ scale_color_viridis(discrete = T)+ theme_blank()
dimred2021_knn250_3 %>% filter(year%in% 2015:2021) %>% group_by(year,pscore_cat2) %>% summarise(valueA=mean(SL.UEM.TOTL.NE.ZS,na.rm=T)) %>% ggplot(aes(y=valueA,x=year,color=pscore_cat2))+ geom_point()+ geom_line()+ ggtitle(wdi_explained[wdi_explained$`Series Code`%in% "SL.UEM.TOTL.NE.ZS","Indicator Name"])+ scale_color_viridis(discrete = T)+ theme_blank()
dimred2021_knn250_3 %>% filter(year%in% 2015:2021) %>% group_by(year,pscore_cat2) %>% summarise(valueA=mean(SH.XPD.GHED.GE.ZS,na.rm=T)) %>% ggplot(aes(y=valueA,x=year,color=pscore_cat2))+ geom_point()+ geom_line()+ ggtitle(wdi_explained[wdi_explained$`Series Code`%in% "SH.XPD.GHED.GE.ZS","Indicator Name"])+ scale_color_viridis(discrete = T)+ theme_blank()

dimred2021_knn250_3 %>% filter(year%in% 2015:2021) %>% group_by(year,pscore_cat2) %>% summarise(valueA=mean(GC.XPN.COMP.ZS,na.rm=T)) %>% ggplot(aes(y=valueA,x=year,color=pscore_cat2))+ geom_point()+ geom_line()+ ggtitle(wdi_explained[wdi_explained$`Series Code`%in% "GC.XPN.COMP.ZS","Indicator Name"])+ scale_color_viridis(discrete = T)+ theme_blank()

dimred2021_knn250_3 %>% filter(year%in% 2010:2021) %>% group_by(year,pscore_level) %>% summarise(valueA=mean(GC.XPN.COMP.ZS,na.rm=T)) %>% ggplot(aes(y=valueA,x=year,color=pscore_level))+ geom_point()+ geom_line()+ ggtitle(wdi_explained[wdi_explained$`Series Code`%in% "GC.XPN.COMP.ZS","Indicator Name"])+ scale_color_viridis(discrete = T)+ theme_blank()
dimred2021_knn250_3 %>%  select(pscore_mean,pscore_level)
dimred2021_knn250_3%>% filter(year%in% 2015:2021,!is.na(GC.XPN.COMP.ZS)) %>% select(`Country Code`,year,`GC.XPN.COMP.ZS`,pscore_cat2)-> investigate
