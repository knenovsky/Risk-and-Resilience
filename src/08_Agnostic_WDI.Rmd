...
Xgboostinput<-Xgboostinput_covar2%>% scale() %>% data.table() %>% drop_na() %>% rename("New Cases"="new_cases_smoothed_per_million", "Mean temperature"="meanTemp","Oxford stringency"="stringency_index","Urban area(%)" ="urban_percent", 
