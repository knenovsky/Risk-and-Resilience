...
# a %>% ggsave(file="../figures/Lancet_submission/CorTable.pdf",device = "pdf",width = 9,height = 9)
...
b%>% ggsave(file="../figures/Lancet_submission/CorTable_all.pdf",device = "pdf",width = 9,height = 9)
```
