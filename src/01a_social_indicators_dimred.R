...
DATA_DIR <- "../data/" # nolint
FIGURE_DIR <- "../figures/01_figures/"# nolint
WDI_DIR <- paste0(DATA_DIR, "WDI_data_230609/WDI_CSV")# nolint

CLUSTER <- rep("localhost", 20) # nolint
Sys.setenv(OPENBLAS_NUM_THREADS =20)

descriptiveWDI<-fread("../data/WDI_data_230609/WDI_CSV/WDISeries.csv") 
